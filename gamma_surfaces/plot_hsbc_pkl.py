...
"""    
fname = open('hsbc_gs_basal_tbe_2-2-2_xx.pkl', 'rb' )
xx_basal = pickle.load( fname ); fname.close()

fname = open('hsbc_gs_basal_tbe_2-2-2_yy.pkl', 'rb' )
yy_basal = pickle.load( fname ); fname.close()

fname = open('hsbc_gs_basal_tbe_2-2-2_etot.pkl', 'rb' )
etot_basal = pickle.load( fname ); fname.close
...
print(xx_pris, yy_pris, etot_pris)
